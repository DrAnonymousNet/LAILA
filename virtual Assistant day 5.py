...
def wake_up(text):
    ...
    try:
        wakeup_call = ["Nura", "laura", "noora", "nowra" "Nora", "nora"]  # when he hears this (Her name), He wakes up
...
def note(text):
    ...
    var = text
    path = fr"C:\Users\USER\PycharmProjects\NOORA\secretary\{file_name}"
